process DOWNLOADGNOMADMT {
    ...
    script:
    """
    wget -O gnomad.genomes.v${meta.version}.sites.chrM.vcf.gz https://storage.googleapis.com/gcp-public-data--gnomad/release/${meta.version}/vcf/genomes/gnomad.genomes.v${meta.version}.sites.chrM.vcf.bgz
    wget -O gnomad.genomes.v${meta.version}.sites.chrM.vcf.gz.tbi https://storage.googleapis.com/gcp-public-data--gnomad/release/${meta.version}/vcf/genomes/gnomad.genomes.v${meta.version}.sites.chrM.vcf.bgz.tbi
    """
